...
export const metadata: Metadata = {
  ...
  description:
    "أين يقف Chameleon Eye AI اليوم وإلى أين يتجه في مجال الأمان والخصوصية والامتثال.",
};
      ...
      <section className="relative overflow-hidden border-b border-white/8">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          ...
          <p className="mt-4 max-w-2xl text-base leading-8 text-muted sm:text-lg">
            أين يقف Chameleon Eye AI اليوم وإلى أين يتجه.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="rounded-2xl border border-gold/20 bg-gold/5 p-6">
          ...
          <p className="text-sm leading-7 text-muted">
            لا يحمل Chameleon Eye AI حالياً شهادة SOC 2 أو ISO 27001 أو الامتثال لـ HIPAA أو شهادة GDPR.
            تمثّل خريطة الطريق هذه نوايا وليست شهادات مكتملة. يستلزم استخدام Chameleon Eye AI لمعالجة
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          ...
          <Card>
            ...
            <p className="mt-6 text-xs text-muted border-t border-white/8 pt-4">
              خيارات الامتثال المؤسسي متاحة عند الطلب. تواصل مع فريق Chameleon Eye AI لمناقشة متطلباتك
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-3">
            <Card>
              ...
              <p className="mt-2 text-sm leading-6 text-muted">
                يخطط Chameleon Eye AI لإجراء تقييم استعداد خارجي لـ SOC 2. سيحدد هذا الفجوات بين الضوابط
            ...
            <Card>
              ...
              <p className="mt-2 text-sm leading-6 text-muted">
                لا يحمل Chameleon Eye AI حالياً تقرير SOC 2 النوع الأول أو النوع الثاني. يجب التحقق من
                أي ادعاءات بشأن امتثال SOC 2 مباشرةً مع فريق Chameleon Eye.
              </p>
            </Card>
            <Card>
              ...
              <p className="mt-2 text-sm leading-6 text-muted">
                ...
                الجدول الزمني والنطاق مع فريق Chameleon Eye AI كجزء من تعامل مؤسسي.
              </p>
            </Card>
          </div>
        </div>
